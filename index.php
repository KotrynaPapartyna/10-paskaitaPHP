...
// tikriname trinti mygtuko funkcionaluma 
if(isset($_GET["trinti"])) {
    $t_id=$_GET["t_id"]; 
   

    // reikia patikrinti- ar informacinis cookie egizstuoja, 
    // is cookie pasiimti masyva
    // tikrinti ar t_id sutampa su kliento duomenimis 
if(isset($_COOKIE["klientai"])) {
        $klientai=$_COOKIE["klientai"]; // reikia paversti i masyva 
        $klientai = explode("|", $klientai); // tekstas paversta i masyva 
...
// ciklo nereikia
        ...
        // reikia implode ir atnaujinti ir paleisti cookie 
        
    }
    echo "trinimo elemento id:".$t_id; 
}
...
foreach($eilute as $stulpelis) { // 7 stulpeliai
    ...
    echo "</tr>";
    // atvaizduok kiekvieno masyvo elemento numeriuka 
    $indeksas++; 
}
...
// tikrinimas- ar toks sausainiukas jau egzistuoja 
